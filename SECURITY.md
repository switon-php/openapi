...
Security fixes are provided for **currently supported release lines** of `switon/openapi` (`switon/openapi` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/openapi/security/advisories/new)
